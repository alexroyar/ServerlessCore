...
strip_virtualenv () {
    ...
    pushd $VIRTUAL_ENV/lib64/python2.7/site-packages/ && zip -r -9 -q /home/enviroment/libs/venv.zip * ; popd
    echo "site-packages compressed size $(du -sh /home/enviroment/libs/venv.zip | cut -f1)"

    pushd $VIRTUAL_ENV && zip -r -q /home/enviroment/libs/full-venv.zip * ; popd
    echo "venv compressed size $(du -sh /home/enviroment/libs/full-venv.zip | cut -f1)"
}
